...
MODULE VECTORMOD
    ...
    CONTAINS
        PROCEDURE::INIT, DESTROY, APPEND, PRINT, GETSIZE, HAS, PREPEND, GET, GETMAXSIZE, MAKEPRECISE, HELP, MUTE
...
CONTAINS
    ...
    SUBROUTINE RESIZE(SELF)
        ...
        IF(SELF%M .EQV. .FALSE.) THEN
            PRINT*,
            PRINT*, 'RESIZING FROM:', SELF%MAXSIZE, '          ->', MULTIPLE
            PRINT*,
        END IF
